...
const MedicalHistory1 = ({ data }) => {
  ...
  const [medicalData, setMedicalData] = useState({
    ...
    Dental_or_Oral: { detail: "", comment: "" , children: []},
  ...
  const relationshipOptions3 = [
    { value: "brother", label: "Brother" },
    { value: "father", label: "Father" },
    { value: "paternalGrandFather", label: "Paternal Grand Father" },
    { value: "maternalGrandFather", label: "Maternal Grand Father" },
  ];
  const relationshipOptions4 = [
    { value: "sister", label: "Sister" },
    { value: "mother", label: "Mother" },
    { value: "paternalGrandMother", label: "Paternal Grand Mother" },
    { value: "maternalGrandMother", label: "Maternal Grand Mother" },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updatedFormdata = { ...formData, aadhar: aadhar };
        ...
        {showForm && (
          <form>
            <div style={tableContainerStyle}>
              <table style={tableStyle}>
                ...
                <tbody>
                  ...
                  {/* Vertigo Row */}
                  <tr style={cellStyle}>
                    <td style={cellStyle}>Vertigo</td>
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData.Vertigo?.detail || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Vertigo",
                            "detail",
                    ...
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData.Vertigo?.children || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Vertigo",
                            "history",
                  ...
                  {/* Mental Illness Row */}
                  <tr style={cellStyle}>
                    <td style={cellStyle}>Mental Illness</td>
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData.Mental_Illness?.detail || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Mental_Illness",
                            "detail",
                    ...
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData.Mental_Illness?.children || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Mental_Illness",
                            "history",
            ...
            disabled = {true}                      />
                  ...
                  {/* ENT Row */}
                  <tr style={cellStyle}>
                    <td style={cellStyle}>ENT</td>
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData.ENT?.detail || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "ENT",
                            "detail",
                    ...
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData.ENT?.children || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "ENT",
                            "history",
  ...
  <tr style={cellStyle}>
    ...
    <td style={cellStyle}>
      ...
      />
                  ...
                  {/* Musculo_Skeletal (Bone, Muscle,Tendon)Row */}
                  <tr style={cellStyle}>
                    <td style={cellStyle}>Musculo Skeletal</td>
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData.Musculo_Skeletal?.detail || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Musculo_Skeletal",
                            "detail",
                        ...
                        style={inputStyle}
                        placeholder="Fractures, Amputations, Ligament/muscle/tendon Injuries"
                        disabled={!isEditMode}
                      />
                    </td>
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData.Musculo_Skeletal?.children || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Musculo_Skeletal",
                            "history",
                  ...
                  {/* Skin Row */}
                  <tr style={cellStyle}>
                    <td style={cellStyle}>Skin</td>
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData["Skin"]?.detail || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Skin",
                            "detail",
                    ...
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData["Skin"]?.children || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Skin",
                            "history",
                  ...
                  {/* Dental/OralRow */}
                  <tr style={cellStyle}>
                    <td style={cellStyle}>Dental/Oral</td>
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData["Dental_Oral"]?.detail || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Dental_Oral",
                            "detail",
                    ...
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData["Dental_Oral"]?.children || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Dental_Oral",
                            "history",
            ...
            />
                  ...
                  <tr style={cellStyle}>
                    ...
                    <td style={cellStyle}>
                      <input
                        type="text"
                        value={medicalData["Prostate_Genital"]?.children || ""}
                        onChange={(e) =>
                          handleMedicalInputChange(
                            "Prostate_Genital",
                            "history",
    ...
    <table style={tableStyle}>
        ...
        <tbody>
          ...
          {/* DM Row */}
            ...
            <tr>
              ...
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                ...
                {/* Vertigo Row */}
            <tr>
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>Vertigo</td>
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                  <Select
                      isMulti
                      options={relationshipOptions1}
                      value={conditions.Vertigo ? relationshipOptions1.filter(option => conditions.Vertigo.includes(option.value)) : []}
                      onChange={(selectedOptions) => {
                          handleSelectionChange("Vertigo", selectedOptions);
                      }}
                      styles={customStyles}
                      placeholder="Select Options"
                      disabled={!isEditMode}
              ...
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                  <input
                      type="text"
                      value={familyHistory.Vertigo?.comment || ''}
                      onChange={(e) => handleFamilyMedicalConditionChange("Vertigo", "comment", e.target.value)}
                      style={{
                          width: '100%',
                          padding: '0.375rem 0.75rem',
                          border: '1px solid #ced4da',
                ...
                {/* Mental Illness Row */}
            <tr>
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>Mental Illness</td>
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                  <Select
                      isMulti
                      options={relationshipOptions1}
                      value={conditions.Mental_Illness ? relationshipOptions1.filter(option => conditions.Mental_Illness.includes(option.value)) : []}
                      onChange={(selectedOptions) => {
                          handleSelectionChange("Mental_Illness", selectedOptions);
                      }}
                      styles={customStyles}
                      placeholder="Select Options"
                      disabled={!isEditMode}
              ...
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                  <input
                      type="text"
                      value={familyHistory.Mental_Illness?.comment || ''}
                      onChange={(e) => handleFamilyMedicalConditionChange("Mental_Illness", "comment", e.target.value)}
                      style={{
                          width: '100%',
                          padding: '0.375rem 0.75rem',
                          border: '1px solid #ced4da',
          ...
          <tr style={cellStyle}>
                ...
                {/* ENT Row */}
            <tr>
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>ENT</td>
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                  <Select
                      isMulti
                      options={relationshipOptions1}
                      value={conditions.ENT ? relationshipOptions1.filter(option => conditions.ENT.includes(option.value)) : []}
                      onChange={(selectedOptions) => {
                          handleSelectionChange("ENT", selectedOptions);
                      }}
                      styles={customStyles}
                      placeholder="Select Options"
                      disabled={!isEditMode}
              ...
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                  <input
                      type="text"
                      value={familyHistory.ENT?.comment || ''}
                      onChange={(e) => handleFamilyMedicalConditionChange("ENT", "comment", e.target.value)}
                      style={{
                          width: '100%',
                          padding: '0.375rem 0.75rem',
                          border: '1px solid #ced4da',
                ...
                {/* Prostate & Genital Row */}
            <tr>
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>Prostate & Genital</td>
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                  <Select
                      isMulti
                      options={relationshipOptions3}
                      value={conditions.Prostate_Genital ? relationshipOptions3.filter(option => conditions.Prostate_Genital.includes(option.value)) : []}
                      onChange={(selectedOptions) => {
                          handleSelectionChange("Prostate_Genital", selectedOptions);
                      }}
                      styles={customStyles}
                      placeholder="Select Options"
                      disabled={!isEditMode}
              ...
              <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                  <input
                      type="text"
                      value={familyHistory.Prostate_Genital?.comment || ''}
                      onChange={(e) => handleFamilyMedicalConditionChange("Prostate_Genital", "comment", e.target.value)}
                      style={{
                          width: '100%',
                          padding: '0.375rem 0.75rem',
                          border: '1px solid #ced4da',
                  ...
                  />
                             ...
                             <tr>
                                ...
                                <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                                    <Select
                                        isMulti
                                        options={relationshipOptions4}
                                        value={medicalData.Obstetric?.detail ? relationshipOptions4.filter(option => medicalData.Obstetric.detail.includes(option.value)) : []}
                                        onChange={(selectedOptions) => {
                                            const selectedValues = selectedOptions ? selectedOptions.map(option => option.value) : [];
                                            handleMedicalInputChange("Obstetric", "detail", selectedValues);
                                        }}
                             ...
                             <tr>
                                ...
                                <td style={{ padding: '0.5rem', borderBottom: '1px solid #dee2e6' }}>
                                    <Select
                                        isMulti
                                        options={relationshipOptions4}
                                        value={medicalData.Gynaec?.detail ? relationshipOptions4.filter(option => medicalData.Gynaec.detail.includes(option.value)) : []}
                                        onChange={(selectedOptions) => {
                                            const selectedValues = selectedOptions ? selectedOptions.map(option => option.value) : [];
                                            handleMedicalInputChange("Gynaec", "detail", selectedValues);
                                        }}
