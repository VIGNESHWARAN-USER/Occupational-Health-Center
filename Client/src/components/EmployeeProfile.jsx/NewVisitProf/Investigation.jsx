...
const parameterOptions = {
    ...
    enzymescardiacprofile: ["acid_phosphatase", "adenosine_deaminase", "amylase", "ecg", "troponin_t", "troponin_i", "cpk_total", "echo", "lipase", "cpk_mb", "tmt_normal"],
    ...
    otherstest: ["Bone_Densitometry", "Dental", "Pathology"],
    ophthalmicreport: ["vision", "color_vision", "Cataract_glaucoma"],
    xray: ["Chest", "Spine", "Abdomen", "KUB", "Pelvis"],
    usgreport: ["usg_abdomen", "usg_kub", "usg_pelvis", "usg_neck"],
    ctreport: ["CT_brain", "CT_lungs", "CT_abdomen", "CT_spine", "CT_pelvis"],
    mrireport: ["mri_brain", "mri_lungs", "mri_abdomen", "mri_spine", "mri_pelvis"],
};
